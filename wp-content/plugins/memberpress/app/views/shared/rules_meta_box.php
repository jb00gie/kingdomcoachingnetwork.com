...
<table class="mepr-rules-table">
  <tr>
    ...
    <td class="mepr-products-col">
      <h4><?php _e('Products with Access:', 'memberpress'); ?></h4>
      <p class="description"><?php _e('Members who are active on any of these products will be able to access this content. This list is calculated from the Rules that protect this content.', 'memberpress'); ?></p>
      <table>
        <?php
