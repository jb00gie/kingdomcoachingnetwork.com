...
<div class="product-options-panel">
  <div id="mepr-simultaneous-purchases">
    ...
    <label for="<?php echo MeprProduct::$simultaneous_subscriptions_str; ?>"><?php _e('Allow users to create multiple, active subscriptions to this product', 'memberpress'); ?></label>
  </div>
  <br/>
  <div id="mepr-who-can-purchase">
    <label><?php _e('Who can purchase this Product', 'memberpress'); ?></label>
