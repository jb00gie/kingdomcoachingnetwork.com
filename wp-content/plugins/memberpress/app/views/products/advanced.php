...
<div class="product-options-panel">
  <div id="mepr-product-access-url">
    <label for="<?php echo MeprProduct::$access_url_str; ?>"><?php _e('Product Access URL', 'memberpress'); ?></label>
    <?php MeprAppHelper::info_tooltip('mepr-product-access-url',
                                      __('Product Access URL', 'memberpress'),
                                      __('This is the URL where those who purchase this product can get the content they now have access to.', 'memberpress').'<br/><br/>'.__('When set, the Product Access URL will make this product name clickable when a member views their Subscriptions/Payments tabs on the Account page.', 'memberpress'));
    ?>
    &nbsp;&nbsp;
  ...
  <div id="mepr-register-price" class="mepr-product-adv-item">
    <label for="<?php echo MeprProduct::$register_price_action_str; ?>">
      <span><?php _e('Registration Pricing Terms:', 'memberpress'); ?></span>
      ...
      <?php
        MeprAppHelper::info_tooltip( 'mepr-register-price',
                                     __('Registration Pricing Terms', 'memberpress'),
                                     __('By default MemberPress will automatically generate the pricing terms for you on the product registration page. But in some cases you\'ll want to either present custom text for the terms ... or hide it alltogether.', 'memberpress') . '<br/><br/>' .
                                     __('This will allow you to customize the pricing terms on the <b>Registration Page</b> for this product. Here\'s a description of these options:', 'memberpress') . '<br/><br/>' .
                                     __('<b>Default:</b> This will enable the system-generated product terms on the Registration form for this product.', 'memberpress') . '<br/><br/>' .
                                     __('<b>Custom:</b> This will enable you to enter your own description for your product terms on the Registration form for this product.', 'memberpress') . '<br/><br/>' .
                                     __('<b>Hidden:</b> This will hide the product terms on the Registration page.', 'memberpress') );
      ?>
    </label>
  ...
  <?php do_action('mepr-product-advanced-metabox', $product); ?>
</div>
