...
class MeprAdminNewSubEmail extends MeprBaseOptionsAdminEmail {
  ...
  public function set_defaults() {
    ...
    $this->title = __('<b>New Subscription</b> Notice','memberpress');
    $this->description = __('This email is sent to you when a subscription is created.', 'memberpress');
    $this->ui_order = 1;

    $enabled = $use_template = $this->show_form = true;
    $subject = __('** New Subscription: {$subscr_num}', 'memberpress');
...
<div id="header" style="width: 680px; padding 0; margin: 0 auto; text-align: left;">
  <h1 style="font-size: 30px; margin-bottom: 0;"><?php _e('New Subscription', 'memberpress'); ?></h1>
...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div class="section" style="display: block; margin-bottom: 24px;"><?php _e('A subscription was just created on {$blog_name}:', 'memberpress'); ?></div>
