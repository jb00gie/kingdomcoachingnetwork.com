...
<div class="info_block">
  ...
  <h3><?php echo MeprAppHelper::format_currency(MeprReports::get_revenue($curr_month, false, $curr_year, $curr_product) + MeprReports::get_refunds($curr_month, false, $curr_year, $curr_product), true, false); ?></h3>
</div>
