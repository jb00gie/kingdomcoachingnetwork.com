...
<form name="mepr_reset_password_form" id="mepr_reset_password_form" action="" method="post">
  ...
  <p>
	...
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit" class="button-primary mepr-share-button mepr_front_button" value="<?php _e('Reset Password', 'memberpress'); ?>" tabindex="720" />
