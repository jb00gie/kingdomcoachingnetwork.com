...
<div id="header" style="width: 680px; padding 0; margin: 0 auto; text-align: left;">
  <h1 style="font-size: 30px; margin-bottom: 0;"><?php _e('Subscription Paused', 'memberpress'); ?></h1>
...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div class="section" style="display: block; margin-bottom: 24px;"><?php _e('A subscription was paused on {$blog_name}:', 'memberpress'); ?></div>
  <table style="clear: both;" class="transaction">
    ...
    <tr><th style="text-align: left;"><?php _e('Auto-Rebilling:', 'memberpress'); ?></th><td><?php _e('Paused', 'memberpress'); ?></td></tr>
